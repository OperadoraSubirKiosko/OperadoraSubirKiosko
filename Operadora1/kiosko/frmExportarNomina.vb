            ...
            If lsvLista.CheckedItems.Count > 0 Then
                ...
                For Each producto As ListViewItem In lsvLista.CheckedItems
                    ...
                    If Trim(producto.SubItems(5).Text) <> "" Then
                        ...
                        Ruta = "\\pagina-pc\pagosnOPERADORAMX\" & Trim(producto.SubItems(5).Text) & ".pdf"
                    ...
                    If Trim(producto.SubItems(7).Text) <> "" Then
                        ...
                        Ruta = "\\pagina-pc\pagosnOPERADORAMX\" & Trim(producto.SubItems(7).Text) & ".pdf"
                    ...
                    If Trim(producto.SubItems(8).Text) <> "" Then
                        ...
                        Ruta = "\\pagina-pc\pagosnOPERADORAMX\" & Trim(producto.SubItems(8).Text) & ".pdf"
                    ...
                    If Trim(producto.SubItems(9).Text) <> "" Then
                        ...
                        Ruta = "\\pagina-pc\pagosnOPERADORAMX\" & Trim(producto.SubItems(9).Text) & ".xml"
                ...
                If bSubir Then
                    For Each producto As ListViewItem In lsvLista.CheckedItems
                        ...
                        If rwUsuarioK Is Nothing = False Then
                            'insertamos el pago
                            'Insertar nuevo
                            SQL = "EXEC setPagoInsertar   0," & rwUsuarioK(0)("iIdUsuarioK").ToString() & ",'" & Date.Parse(Trim(producto.SubItems(1).Text)).ToShortDateString() & "',1,"
                            ...
                            SQL &= IIf(chkNominaB.Checked = True, txtcarpeta.Text, "") & "',1"
